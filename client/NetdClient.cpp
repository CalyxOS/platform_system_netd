...
// This function is declared here and defined below
...
// Check if current process should be allowed to use networks.
// Defaults to true in case of errors obtaining the status from TrafficController and for root UID.
bool getNetworkingAllowedForProcess() {
